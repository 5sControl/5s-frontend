...
export const AlgorithmList = ({
  ...
  return (
    <div className="selection">
      {algorithmPage === 'main' && (
        <>
          ...
          <h3 className="selection__subtitle">
            Select algorithms and cameras that will use them to start monitoring. You can always
            change your setup by going to the specific algorithms from Algorithms tab.
          </h3>
        </>
      )}
      ...
      <div
        className={
          algorithmList.machine_control ? 'selection__container' : 'selection__container noAccess'
        }
      ...
      <div
        className={
          algorithmList.idle_control ? 'selection__container' : 'selection__container noAccess'
        }
      ...
      <div
        className={
          algorithmList.staff_control ? 'selection__container ' : 'selection__container noAccess'
        }
