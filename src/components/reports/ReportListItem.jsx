    ...
    return (
        <>
           <div className='dashboard__reports_item' onClick={()=>setCurrentReport(item)}>
                ...
                {
                  window.location.pathname.includes('safety') &&  <div><Algorithm/> Safety control:{item.action}</div>
                }
                {
                  window.location.pathname.includes('idle') &&  <div><Algorithm/> Idle control</div>
                }
                {
                  window.location.pathname.includes('machine') &&  <div><Algorithm/> Machine control</div>
                }
